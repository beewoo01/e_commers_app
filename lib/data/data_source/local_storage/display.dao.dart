...
class DisplayDao {
  ...
  Future<ResponseWrapper<List<CartEntity>>> clearCarts() async {
    ...
    return ResponseWrapper(
      status: 'SUCCESS',
      code: '0000',
      message: '성공적으로 장바구니를 전체 삭제 완료했습니다.',
      data: [],
    );
  }
  ...
  Future<ResponseWrapper<List<CartEntity>>> changeQtyCart(
    ...
    if (currentCart == null) {
      ...
      final message = '네트워크 오류가 발생했습니다. 잠시 후레 다시 시도해 주세요.';
    ...
    return ResponseWrapper(
      status: 'SUCCESS',
      code: '0000',
      message: '성공적으로 ${currentCart.product.title}의 수량을 변경완료했습니다.',
      data: localStorage.values.toList(),
    );
  }
}
