...
/// @nodoc
mixin _$Menu implements DiagnosticableTreeMixin {
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('tabId', tabId))..add(DiagnosticsProperty('title', title));
}
...
class _Menu with DiagnosticableTreeMixin implements Menu {
